...
class PacketSessionData(ctypes.LittleEndianStructure):
    ...
    _fields_ = [
        ...
        ('m_sessionType', ctypes.c_ubyte),
        # 0 = unknown, 1 = P1, 2 = P2, 3 = P3, 4 = Short P,  5 = Q1, 6 = Q2
        ...
        # List of marshal zones – max 21List of marshal zones – max 21
        ('m_safetyCarStatus', ctypes.c_ubyte),
...
class PacketEventData(ctypes.LittleEndianStructure):
    ...
    _fields_ = [
        ...
        # Event string code: "SSTA" = Sent when the session starts,
...
class CarStatusData(ctypes.LittleEndianStructure):
    ...
    _fields_ = [
        ...
        # Modern - 0 = hyper soft, 1 = ultra soft, 2 = super soft
        ...
        # ERS deployment mode, 0 = none, 1 = low, 2 = medium, 3 = high
        #  4 = overtake, 5 = hotlap
